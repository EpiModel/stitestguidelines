...
param <- param_msm(nwstats = st,
                   ...
                   stianntest.syph.hivneg.coverage = 0.45, #0.44, #0.44, # 0.45
                   stihighrisktest.gc.hivneg.coverage = 0.01,
                   stihighrisktest.ct.hivneg.coverage = 0.01,
                   stihighrisktest.syph.hivneg.coverage = 0.01, #0.05,
                   stianntest.gc.hivpos.coverage = 0.61,
                   stianntest.ct.hivpos.coverage = 0.61,
                   stianntest.syph.hivpos.coverage = 0.67, #0.65, #0.67
                   stihighrisktest.gc.hivpos.coverage = 0.01,
                   stihighrisktest.ct.hivpos.coverage = 0.01,
                   stihighrisktest.syph.hivpos.coverage = 0.01, #0.05,

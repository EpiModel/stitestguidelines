...
df <- data.frame(elig, gc.incid.low, gc.incid, gc.incid.high, gc.hr.low, gc.hr, gc.hr.high, 
...
names(df$elig) <- names(df$gc.incid.low) <- names(df$gc.incid) <- names(df$gc.incid.high) <- names(df$gc.hr.low) <- names(df$gc.hr) <- names(df$gc.hr.high) <-

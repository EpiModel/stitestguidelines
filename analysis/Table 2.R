...
df <- data.frame(anncov, hrcov, annint, hrint, partcut,
                 ...
                 # Overall
                 gc.incid, gc.pia, gc.asympt.tests.py, gc.asympt.tests, gctx, gctxpy, gc.nnt,
                 ct.incid, ct.pia, ct.asympt.tests.py, ct.asympt.tests, cttx, cttxpy, ct.nnt,
                 syph.incid, syph.pia, syph.asympt.tests.py, syph.asympt.tests,
                 syphtx, syphearlytx, syphlatetx, syphtxpy, syphearlytxpy, syphlatetxpy,
                 syph.nnt, sti.incid, sti.pia, sti.asympt.tests.py, sti.asympt.tests, tx.sti, txperpy.sti, sti.nnt,
...
for (i in seq_along(sims)) {
  ...
  # By group done with standardized rates, rather than missing incid.sti.g1
...
#
# Partner Cutoff for Higher-Risk
# 3221:3229 Higher-risk = 2 (ref) to 10 by 1

# Newer way:
# 3191 has 6 month HR, 12 month SA, and 1 partner cutoff
...
write.csv(df, "analysis/STD Table 2a.csv")
